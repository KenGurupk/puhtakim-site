      ...
      <div className="mx-auto flex min-h-[60vh] max-w-7xl flex-col justify-center">
        ...
        <div className="mt-10 grid max-w-4xl gap-3 sm:grid-cols-4">
          {[
            ...
            <Reveal key={item.src} delay={index * 0.05} className="h-full" variant="card">
              <div className="motion-card relative min-h-44 overflow-hidden rounded-2xl border border-white/10 bg-black/40 shadow-[0_18px_70px_rgba(0,0,0,0.28)]">
                <Image
                  src={item.src}
                  alt={copy.headline}
                  fill
