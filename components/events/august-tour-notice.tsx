...
export function AugustTourNotice() {
  function scrollToRecaps() {
    const target = document.getElementById("tour-recaps") ?? document.getElementById("event-stops");
      ...
      <div className="mx-auto max-w-7xl">
        <div className="rounded-3xl border border-blood/35 bg-white/[0.045] p-5 shadow-[0_24px_90px_rgba(193,18,31,0.12)] sm:p-7 lg:flex lg:items-center lg:justify-between lg:gap-8">
          <div className="max-w-4xl">
            <p className="text-xs font-black tracking-[0.16em] text-amber-200">PUSH TOUR 2026 הסתיים</p>
            ...
            <p className="mt-3 text-base font-bold leading-7 text-zinc-200">
              תודה לכל מי שהתאמן, התחרה, עזר, צילם, אירח, נתן חסות או פשוט היה חלק מהדרך.
            </p>
            <p className="mt-2 text-sm font-black text-blood">הסבב הסתיים, אבל אנחנו רק מתחממים ↓</p>
          </div>

          <button
            type="button"
            onClick={scrollToRecaps}
