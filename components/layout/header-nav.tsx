        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              className={`rounded-full px-3 py-2 text-sm font-bold transition duration-300 hover:-translate-y-0.5 hover:bg-white/10 hover:text-white ${
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              aria-current={active ? "page" : undefined}
              className={`shrink-0 rounded-full px-3 py-2 text-sm font-bold transition duration-300 hover:bg-white/10 hover:text-white active:scale-[0.98] ${
